...
/**
 * Before a Process is started, the ProcessStartedEvent is inserted into the Drools
 * KieSession and all rules are fired.
 * 
 * @author ezegrande
 *
 */
public class InsertProcessEventListener implements ProcessEventListener {
	private static Logger logger = LoggerFactory
			.getLogger(InsertProcessEventListener.class);
	...
	public void beforeProcessStarted(ProcessStartedEvent event) {
		logger.info("Process {} is getting started. Id: {} ", event
				.getProcessInstance().getProcessId(), event
